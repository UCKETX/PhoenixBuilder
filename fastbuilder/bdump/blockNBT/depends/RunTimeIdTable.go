...
var ContainerDataToBlockRunTimeId map[SingleContainer]uint32 = map[SingleContainer]uint32{
	{"lava_cauldron", 0}:  616,
	{"lava_cauldron", 1}:  617,
	{"lava_cauldron", 2}:  618,
	{"lava_cauldron", 3}:  619,
	...
	{"lava_cauldron", 8}:  623,
	{"lava_cauldron", 9}:  624,
	{"lava_cauldron", 10}: 625,
	{"lava_cauldron", 11}: 626,
	{"lava_cauldron", 12}: 627,
	{"lava_cauldron", 13}: 628,
	{"lava_cauldron", 14}: 629,
	{"lava_cauldron", 16}: 630,
	{"lava_cauldron", 17}: 631,
	{"lava_cauldron", 18}: 632,
	{"lava_cauldron", 19}: 633,
	{"lava_cauldron", 20}: 634,
	{"lava_cauldron", 21}: 635,
	{"lava_cauldron", 22}: 636,
	// 岩浆炼药锅
	{"smoker", 0}: 655,
	{"smoker", 1}: 656,
	{"smoker", 2}: 657,
	...
	{"shulker_box", 15}: 5282,
	// 染色的潜影盒
	{"trapped_chest", 0}: 5534,
	{"trapped_chest", 1}: 5535,
	{"trapped_chest", 2}: 5536,
	{"trapped_chest", 3}: 5537,
	{"trapped_chest", 4}: 5538,
	{"trapped_chest", 5}: 5539,
	// 陷阱箱
	{"hopper", 0}:  6813,
	{"hopper", 1}:  6814,
	{"hopper", 2}:  6815,
	...
	{"lectern", 7}: 6864,
	// 讲台
	{"lit_blast_furnace", 0}: 7019,
	{"lit_blast_furnace", 1}: 7020,
	{"lit_blast_furnace", 2}: 7021,
	{"lit_blast_furnace", 3}: 7022,
	{"lit_blast_furnace", 4}: 7023,
	{"lit_blast_furnace", 5}: 7024,
	// 发光的高炉
	{"chest", 0}: 7058,
	{"chest", 1}: 7059,
	{"chest", 2}: 7060,
	...
	{"cauldron", 22}: 7418,
	// 炼药锅
	{"brewing_stand", 0}: 7490,
	{"brewing_stand", 1}: 7491,
	{"brewing_stand", 2}: 7492,
	{"brewing_stand", 3}: 7493,
	{"brewing_stand", 4}: 7494,
	{"brewing_stand", 5}: 7495,
	{"brewing_stand", 6}: 7496,
	{"brewing_stand", 7}: 7497,
	// 酿造台
	{"blast_furnace", 0}: 7510,
	{"blast_furnace", 1}: 7511,
	{"blast_furnace", 2}: 7512,
	{"blast_furnace", 3}: 7513,
	{"blast_furnace", 4}: 7514,
	{"blast_furnace", 5}: 7515,
	// 高炉
	{"lit_smoker", 0}: 7636,
	{"lit_smoker", 1}: 7637,
	{"lit_smoker", 2}: 7638,

...
// copied from https://github.com/Sandertv/gophertunnel
const (
...
var ContainerIdIndexMap map[string]int = map[string]int{
	"smoker":             28,
	"undyed_shulker_box": ContainerShulkerBox,
	"shulker_box":        ContainerShulkerBox,
	"trapped_chest":      7,
	"lit_blast_furnace":  45,
	"chest":              7,
	"lit_furnace":        25,
	"dropper":            7,
	"blast_furnace":      45,
